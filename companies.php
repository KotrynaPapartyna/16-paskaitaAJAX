...
<body>
    ...
    <div class="container">
        ...
        <div class="companyForm d-none">
            ...
            <input id="tipas_id" class="form-control" placeholder="Įveskite tipo ID" />
        ...
        <div id="output">
            <table class="table table-striped">
                ...
                $sql = "SELECT imones.ID, 
                imones.pavadinimas AS imones_pavadinimas, 
                imones.aprasymas AS imones_aprasymas, 
                imones_tipas.pavadinimas AS imones_tipas_pavadinimas, 
                imones_tipas.aprasymas AS imones_tipas_aprasymas 
                FROM `imones` 
